...
--
-- Host: localhost
-- Generation Time: Feb 08, 2017 at 08:38 AM
...
(1, 'system_name', 'primus School Management System Pro'),
(2, 'system_title', 'primus School'),
(3, 'address', 'Dhaka, Bangladesh'),
(4, 'phone', '+8012654159'),
(5, 'paypal_email', 'payment@school.com'),
(6, 'currency', 'usd'),
(7, 'system_email', 'school@primus.com'),
...
--
ALTER TABLE `language`
  MODIFY `phrase_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=441;
--
