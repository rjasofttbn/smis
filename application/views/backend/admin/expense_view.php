...
<div class="row">
    ...
    <div class="col-md-3" style="margin-top: 20px;">
        <button type="submit" class="btn btn-info"><?php echo get_phrase('search_expense'); ?></button>
    </div>
...
//                    $query = $this->db->get('payment')->result_array();
                ...
                <?php
                 $total = count($this->uri->segment_array());
                if ($total == 5) { ?>
                    <a href="<?php echo base_url(); ?>index.php?admin/expense_report_print_view/<?php echo $cat; ?>/<?php echo $sdate1; ?>/<?php echo $edate2; ?>" 
                       class="btn btn-primary" target="_blank">
                           <?php echo get_phrase('print_expense_sheet'); ?>
                    </a>
                <?php } else { ?>
                    <a href="<?php echo base_url(); ?>index.php?admin/expense_report_print_view/<?php echo $sdate1; ?>/<?php echo $edate2; ?>" 
                       class="btn btn-primary" target="_blank">
                        <?php echo get_phrase('print_expense_sheet'); ?>
                    </a>
                <?php } ?> 
