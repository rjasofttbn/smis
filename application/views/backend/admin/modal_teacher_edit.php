			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?admin/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="card_no" value="<?php echo $row['card_no'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('status');?></label>
                                    ...
                                    <!--<input type="text" class="form-control" name="email" value="<?php echo $row['tstatus'];?>"/>-->
                                    
                                    <div class="col-sm-5">
                                    <select name="tstatus" class="form-control selectboxit">
                                    	<option value="active" <?php if($row['tstatus'] == 'active')echo 'selected';?>><?php echo get_phrase('active');?></option>
                                    	<option value="inactive" <?php if($row['tstatus'] == 'inactive')echo 'selected';?>><?php echo get_phrase('inactive');?></option>
                                    </select>
                                </div>
