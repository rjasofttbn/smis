<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        if ($page_name == 'manage_attendance' ||
                ...
                || $page_name == 'manage_attendance_teacher'|| $page_name == 'manage_attendance_view_teacher'
                || $page_name == 'attendance_report_teacher'|| $page_name == 'attendance_report_view_teacher'
        ...
        ?> ">
            ...
            <ul>
                <li class="<?php if (( $page_name == 'attendance_report' || $page_name == 'attendance_report_view')) echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/attendance_report">
                        <span><i class="entypo-dot"></i><?php echo get_phrase('attendance_report_student'); ?></span>
                    </a>
                </li>
            ...
            <ul>
                <li class="<?php if (($page_name == 'manage_attendance_teacher' || $page_name == 'manage_attendance_teacher_view')) echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/manage_attendance_teacher">
                        <span><i class="entypo-dot"></i><?php echo get_phrase('daily_atendance_teacher'); ?></span>
                    </a>
                </li>
              ...
              <ul>
                <li class="<?php if (( $page_name == 'attendance_report_teacher' || $page_name == 'attendance_report_view_teacher')) echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/attendance_report_teacher">
                        <span><i class="entypo-dot"></i><?php echo get_phrase('attendance_report_teacher'); ?></span>
                    </a>
                </li>
        ...
        <li class="<?php if ($page_name == 'manage_test') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/manage_test">
                <i class="entypo-lock"></i>
