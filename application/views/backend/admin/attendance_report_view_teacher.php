...
<?php echo form_open(base_url() . 'index.php?admin/attendance_report_teacher_selector'); ?>
<div class="row">
    <div class="col-md-2">
        ...
        <div class="col-md-12">
            <table class="table table-bordered" id="my_table">
                ...
                <tbody>
                    ...
                    $yy = substr($running_year, 5, 10);
                    $cmy = strtotime($date . '' . $yy);
                    $sd = strtotime(date('M Y', $cmy));

//                    print_r($my);
//                    exit;
                    $teachers = $this->db->get_where('teacher_attendance', array('month_year' => $sd))->result_array();
            ...
            <center>
                <a href="<?php echo base_url(); ?>index.php?admin/attendance_report_print_view_teacher/<?php echo $month; ?>/<?php echo $sessional_year; ?>" 
